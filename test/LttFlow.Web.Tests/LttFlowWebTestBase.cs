...
{
    public abstract class LttFlowWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LttFlowWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LttFlowWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LttFlowDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LttFlowDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LttFlowDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LttFlowDbContext, Task<T>> func)
        {
            T result;
