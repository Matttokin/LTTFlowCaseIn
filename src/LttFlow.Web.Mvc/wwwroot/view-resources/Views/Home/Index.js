...
$(function () {
    ...
    var gaseChartCanvas = $('#gaseChart').get(0).getContext('2d');

    var gaseChartNewCanvas = $('#gaseChartNew').get(0).getContext('2d');
    ...
    _meterReadingService.getChartData().done(function (result) {
        ...
        var salesChart = new Chart(gaseChartCanvas, {
            type: 'bar',
            data: salesChartData,
    ...
    arrayfil.forEach(das => {
        ...
        for (var i = 0; i < 4; i++) {
            dataset.data.push(getRandomInt(100));
        }
        salesChartData.labels.push(das.date);
        salesChartData.datasets.push(dataset);
    });

    var salesChart = new Chart(gaseChartNewCanvas, {
        type: 'line',
        data: salesChartData,
        options: salesChartOptions
    });
